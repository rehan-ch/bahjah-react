...
export default function AppLayout({
    ...
    return (
        <div
            className="min-h-dvh overflow-y-scroll w-full overflow-x-hidden bg-custom text-white flex flex-col justify-between"
        >
            ...
            <main
                className={`${spreadItems ? "" : "flex-1"} pt-4 px-4 md:w-[400px] md:mx-auto`}
            >
                <Outlet />
            </main>
