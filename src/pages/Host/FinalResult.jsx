      ...
      <div className="flex flex-col overflow-y-auto">
        <div className="flex-1 px-6 py-4 space-y-6 overflow-y-auto">
          <div className="text-right" dir="rtl">
            <p className="mb-2 text-center">مسابقة اليوم الوطني</p>
          </div>
        ...
        <div className="p-6 flex flex-col space-y-5 justify-center items-center">
          ...
          <Link
            to={"https://www.bahjah.com"}
            className="flex justify-center items-center w-[165px] h-[65px] rounded-full bg-button hover:bg-green-700"
          >
            <img
