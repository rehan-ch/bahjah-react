...
const PlayerQuestions = ({ data }) => {
  ...
  const question =
    questionData?.question || 'ما معنى كلمة "خرمس" باللهجة القصيمية؟';
    ...
    <div className="flex flex-col overflow-y-auto">
      <div className="flex-1 px-6 py-4 space-y-6 overflow-y-auto">
        ...
        <div className="w-full flex justify-between">
          ...
          <h2 className="text-center mr-3">السؤال {currentQuestion}/{totalQuestions}</h2>
        </div>
                ...
                {selectedOption === option && (
                  <div className="w-6 h-6 flex-none flex items-center justify-center">
                    <svg
                      ...
                      className="w-6 h-6"
                    >
                      <title>Option selected icon</title>
                      <path
