      ...
      <div className="min-h-full bg-custom text-white flex flex-col items-center justify-center">
        <div className="text-center" dir="rtl">
          ...
          <div className="flex justify-center">
            <button className="bg-button text-white font-bold py-2 px-4 rounded-[25px] min-w-[120px]" type="button">
        ...
        {!isLoading && !error && data && (
          <>
            ...
            <div dir="rtl">
              ...
              <div className="space-y-3">
                {participants.map((participant, index) => (
                  <div
                    key={participant.id}
                    className="flex items-center justify-between py-2 border-b border-green-700"
                  >
            ...
            <div className="text-center py-8" dir="rtl">
              ...
              <div className="flex justify-center space-x-1">
                <div
                  className="w-2 h-2 bg-green-700 rounded-full animate-pulse ml-1"
